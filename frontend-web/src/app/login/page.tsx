    ...
    <div className="flex min-h-screen items-center justify-center bg-[#060814] px-4">
      ...
      <div className="w-full max-w-md glass-card rounded-2xl p-8 text-slate-100 z-10">
        <div className="flex flex-col items-center mb-8">
          <div className="flex items-center justify-center h-14 w-14 rounded-xl bg-gradient-to-tr from-indigo-500 to-indigo-600 shadow-lg shadow-indigo-500/30 mb-4 animate-pulse">
            <Sparkles className="h-7 w-7 text-white" />
          </div>
          <h1 className="text-2xl font-bold tracking-tight text-white mb-1">Welcome back</h1>
          <p className="text-sm text-slate-400">Perfect your speaking with real-time AI coaching</p>
        </div>
